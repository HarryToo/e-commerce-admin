<template>
  <div class="goods-selector">
    ...
    <div class="goods-list">
      <square-goods-item choosable v-for="item in tableData.list" :key="item.id" :goods="item"
                         :isChecked="item.id === tableData.selectedGoods.id"
                         @change="tableData.chooseChange"></square-goods-item>
    </div>
