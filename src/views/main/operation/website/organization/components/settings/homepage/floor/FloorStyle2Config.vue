<template>
  <div>
    <el-form :model="formData" size="small" label-position="right" label-width="96px">
      ...
      <div class="plate-list" id="organization-web-plate-list-floor-2">
        <div class="plate-item" v-for="(plate, plateIndex) in formData.plates" :key="plateIndex">
          <el-affix target="#organization-web-plate-list-floor-2" :offset="262">
...
export default defineComponent({
  ...
  setup() {
    ...
    watch(floorIndex, (newFloorIndex) => {
      if (store.state.decoration.organizationWebsite.homepage.floor[newFloorIndex].type === 2) {
