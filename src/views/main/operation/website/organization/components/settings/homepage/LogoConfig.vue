...
export default defineComponent({
  ...
  setup() {
    ...
    if (store.state.decoration.organizationWebsite.homepage.logo) {
      formData.value.logoUrl = store.state.decoration.organizationWebsite.homepage.logo
    } else {
    ...
    watch(formData, (data) => {
      ...
      store.commit('decoration/organizationWebsite/saveLogoConfig', logo)
    }, {deep: true})
