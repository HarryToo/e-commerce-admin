    ...
    <el-form :model="formData" size="small" label-position="right" label-width="96px">
      ...
      <el-form-item label="首页入口图片">
        <div style="display: flex;align-items: flex-end;">
          <file-upload v-model="formData.homepageImage" img-size="224*620"></file-upload>
...
export default defineComponent({
  ...
  setup() {
    ...
    watch([floorIndex, floorItemId], ([newFloorIndex, newFloorItemId]) => {
      if (store.state.decoration.organizationWebsite.homepage.floor[newFloorIndex].type === 4 && newFloorItemId !== prevId) {
