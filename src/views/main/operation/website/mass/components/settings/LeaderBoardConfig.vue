<template>
  <div class="form-list" id="mass-web-leader-board-group-list">
    <div v-for="(formData, index) in formDataList" :key="index">
      <el-affix target="#mass-web-leader-board-group-list" :offset="262">
...
export default defineComponent({
  ...
  setup() {
    ...
    const formDataList = ref(store.state.decoration.massWebsite.leaderboard)
    ...
    watch(formDataList, (list) => {
      store.commit('decoration/massWebsite/saveLeaderBoardConfig', list)
    }, {deep: true})
