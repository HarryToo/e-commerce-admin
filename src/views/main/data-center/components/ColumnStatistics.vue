<template>
  <div class="column-statistics block-view">
    <div class="column">
      <img src="/favicon.ico" alt="预警商品数" class="icon">
      <div class="cont">
        <div class="name text-cut-1">预警商品数</div>
        <div class="value text-cut-1">{{ numberFormat(data.warning_goods_num) }}件</div>
      </div>
    </div>
    <div class="column">
      ...
      <div class="cont">
        ...
        <div class="value text-cut-1">{{ numberFormat(data.sale_goods_num) }}件</div>
      </div>
    </div>
    <div class="column">
      ...
      <div class="cont">
        ...
        <div class="value text-cut-1">{{ numberFormat(data.order_num) }}单</div>
      </div>
    </div>
    <div class="column">
      ...
      <div class="cont">
        ...
        <div class="value text-cut-1">{{ numberFormat(data.organization_num) }}个</div>
      </div>
    </div>
    <div class="column">
      ...
      <div class="cont">
        ...
        <div class="value text-cut-1">{{ numberFormat(data.student_num) }}个</div>
      </div>
    </div>
  </div>
</template>
