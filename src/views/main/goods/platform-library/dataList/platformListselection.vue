<template>
	<div class="ScreenCondition">
		...
		<div>
			<el-cascader v-model="chooseClass"  :options="Classoption">
			</el-cascader>
		</div>
	</div>
	<div class="ScreenCondition">
		...
		<div>
			<el-input v-model="priceMin" placeholder="请输入商品标题" size='small'></el-input>
		</div>
		<div class="Title">
			至
		</div>
		...
		<div>
			<el-input v-model="priceMax" placeholder="请输入商品标题" size='small'></el-input>
		</div>
		<div class="Title">
			入库时间
		</div>
		...
		<div>
			<el-input v-model="getshopPeople" placeholder="请输入商品标题" size='small'></el-input>
		</div>
