<template>
	<div class="shopImg" :id='getGood'>
		...
		<div class="shopImg-r1">
			...
			<div class="shopImg-r1-w1">
				...
				<div class="shopImg-r1-w1-r2">
					<draggable class='dragBox' :list="shopImg.goods_image" group="moveOne" @change="GoodImgChange" itemKey="groupOne"
		...
		<div class="shopImg-r1">
			...
			<div class="shopImg-r1-w1">
				<div class="shopImg-r1-w1-r0">
					...
					<el-checkbox v-model="shopImg.skuImgCheckAll" @change="ToCheckAll('goods_sku_image')">全选
					</el-checkbox>
				</div>
				<div class="shopImg-r1-w1-r1">图片格式：JPG, JPEG, PNG; 单张图片大小不能超过1M；图片建议尺寸：800x800；可拖拽移动图片；
				</div>
				<div class="shopImg-r1-w1-r2">
						...
						<draggable class='dragBox' :list="shopImg.goods_sku_image" group="people" @change="GoodSkuImgChange" itemKey="grouTwo"
							animation="300" dragClass="dragClass" ghostClass="ghostClass" chosenClass="chosenClass">
						>
		...
		<!-- 预览图片 -->
		<el-image-viewer v-if="shopImg.showViewer" @close="closeViewer" :url-list="shopImg.srcList" />
	</div>
		...
		methods: {
			...
			ChangeFile(e) {
				...
				reader.onload = (data) => {
					...
					if (that.shopImg.FileIput == 'goods_image') {
						that.shopImg.goods_image[that.shopImg.GoodChangeIdx].img =
							'http://dummyimage.com/150x150/213123'
						that.shopImg.GoodChangeIdx = ''
						that.GoodImgChange()
					} else if (that.shopImg.FileIput == 'goods_sku_image') {
						that.shopImg.goods_sku_image[that.shopImg.SkuChangeIdx].img =
							'http://dummyimage.com/150x150/213123'
